...
describe('Lexer - Unicode Escape', () => {
  const tokens: [Context, Token, string, string][] = [
    ...
    [Context.None, Token.Identifier, '\\u0062\\u0066', 'bf'],
    [Context.None, Token.Identifier, '\\u0067', 'g'],
    [Context.None, Token.Identifier, '\\u0062\\u0066', 'bf'],
    [Context.None, Token.Identifier, '\\u0062\\u0066', 'bf'],
    [Context.None, Token.Identifier, '\\u01F602', 'Ƕ02'],
    [Context.None, Token.Identifier, '\\u{41}', 'A'],
    [Context.None, Token.Identifier, '\\u{0041}', 'A'],
    [Context.None, Token.Identifier, '\\u{03BB}', 'λ'],
    [Context.None, Token.Identifier, '\\u{6728}', '木'],
    [Context.None, Token.Identifier, '\\u{7800}', '砀'],
    [Context.None, Token.Identifier, '\\u{4b00}', '䬀']
  ];

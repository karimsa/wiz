...
describe('Lexer - String', () => {
  const tokens: [Context, Token, string, string][] = [
    ...
    [Context.None, Token.StringLiteral, '"\\u{89abc}"', 'Ȧʼ'],
    [Context.None, Token.StringLiteral, '"\\u{CDEF}"', '췯'],
    [Context.None, Token.StringLiteral, '"\\u{0000000000000000000010ffff}"', 'пϿ'],
    [Context.None, Token.StringLiteral, '"\\u{10ffff}"', 'пϿ'],
    [Context.None, Token.StringLiteral, '"\\u0062"', 'b'],
